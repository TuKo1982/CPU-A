...
namespace DataInfo
{
    const std::map<AOS::Identify::IDCPU, CPUSpec> cpuMC68k2spec {
        ...
        { AOS::Identify::IDCPU::MC68LC040,
          { "Motorola", "68LC040", "5 V", "0.57-0.8 um", "1990", "~3.5-8 W", 1, 1, 4 * 1024, 4 * 1024, 0, 0 } },
        { AOS::Identify::IDCPU::MC68060,
          { "Motorola / Freescale", "68060", "3.3 V", "0.42-0.6 um", "1993", "~2-7 W", 1, 1, 8 * 1024, 8 * 1024, 0, 0 } },
        { AOS::Identify::IDCPU::MC68LC060,
    ...
    const std::map<AOS::Identify::IDPPC, CPUSpec> cpuPPC2spec {
        ...
        { AOS::Identify::IDPPC::PPC603E,
          { "Motorola/IBM", "603e", "2.5 V, 3.3 V", "0.35-0.5 um", "April 1996", "~6 W", 1, 1, 16 * 1024, 16 * 1024, 0, 0 } },
        { AOS::Identify::IDPPC::PPC603P, { "Motorola/IBM", "603p", "2.5 V", "0.35 um", "?", "~4-5 W", 1, 1, 16 * 1024, 16 * 1024, 0, 0 } },
        { AOS::Identify::IDPPC::PPC604,
          { "Motorola/IBM", "604", " 3.3 V", "0.5 um", "April 1994", "~14-17 W", 1, 1, 16 * 1024, 16 * 1024, 0, 0 } },
        { AOS::Identify::IDPPC::PPC604E,
          { "Motorola/IBM", "604e", " 2.5 V", "0.35 um", "1996", "~16-18 W", 1, 1, 32 * 1024, 32 * 1024, 0, 0 } },
